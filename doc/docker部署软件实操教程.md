...
> 前两个网站是英伟达官方仓库（NGC **NVIDIA GPU Cloud**）里的构建pytorch的容器镜像仓库，第二个更是针对Jetson的容器镜像仓库。两个都提供arm架构的镜像，可以用来当作基础镜像。第三个是Dustin Franklin维护的Jetson容器镜像仓库，比官方的仓库更加全面版本更新。
>
> **更推荐第三个**，里面的l4t仓库是专为Jetson设备所设
