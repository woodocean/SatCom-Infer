...
# Windows + PyTorch/Ultralytics can load multiple OpenMP runtimes when this
# script measures several model segments in one process. Keep the workaround
# process-local so it does not modify the user's machine-wide environment.
